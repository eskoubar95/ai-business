...
| 2     | Heartbeat MVP + Agent Configuration     | 🔄 In Progress | 1/2 (PR **#5** open) |
...
| 2.2  | Agent Config Tabs + Run Heartbeat UI + Settings     | Frontend Agent | `phase2/stage2-frontend` (PR **#5**) | 🔄 In review  | `.apm/memory/stage-02/task-02-02.log.md` |
