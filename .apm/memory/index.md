...
| 3.1 — Tasks Backend           | `.apm/memory/stage-03/task-03-01.log.md` | Opgavelog findes på branch **`phase2/stage3-backend`** — merger til `main` afventer PR; eksport/handoff `.apm/bus/backend-agent/handoff.md`        |
